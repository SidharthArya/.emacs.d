# -*- mode: org-mode; after-save-hook: config-compile -*-
  ...
  #+BEGIN_SRC emacs-lisp :tangle init.el
    ...
    (use-package modular-config
      ...
      (modular-config-list '(
                             ...
                             (mail (core mail appearance emoji begin-mail not-org))
                             (news (begin-news core web appearance core-post not-org))
                             ;; core web org emoji 
                             (tracking (core org begin-tracking not-org))
                             (programming (compile core appearance ivy org programming vc))
                             (org (compile begin-org core appearance completion files web finance vi ivy core-post vc programming custom org space server auto))
        ...
        (use-package browse-rules
          ...
          (browse-rules '(
                 ...
                 ;;         (".*\.csv$" t "localc" "%s")
                          ...
                          (".*medium.*" t "firefox" "about:reader?url=%s")
    )))
  #+end_src
* Mail
...
* Misc
** Subtitles
   #+begin_src emacs-lisp :tangle lisp/subtitles.el
                    (use-package subed
                      :ensure rndusr/subed
