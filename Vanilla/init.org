  ...
  #+BEGIN_SRC emacs-lisp :tangle init.el
    ...
    (use-package modular-config
      ...
      (modular-config-list '(
                             ...
                             (news (core web appearance emoji begin-news))
                             ;; core web org emoji 
                             (tracking (core org begin-tracking vi))
                             (programming (compile core appearance ivy org programming vc))
                             (org (compile core appearance programming ivy files web projects finance begin-org core-post dashboard vc vi custom space org server))
                             (doom (begin-org doom))
                             (utilities (core))
...
* Web
  #+begin_src emacs-lisp :tangle lisp/web.el
    (use-package browse-rules
      ...
      (browse-rules '(
                      (".*" t "firefox-developer-edition" "%s")
                      (".*thehindu.*" t "firefox-developer-edition" "about:reader?url=%s"))))
  #+end_src
* Mail
