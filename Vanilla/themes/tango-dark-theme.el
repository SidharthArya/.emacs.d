...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(highlight ((,class (:background ,alum-7))))
   ...
   ;; Line Numbers
   `(line-number ((t (:foreground ,alum-1 :background ,alum-7))))
   `(line-number-current-line ((t (:inherit line-number :foreground ,cham-0))))

   ;; Company
   `(company-tooltip ((,class (:background ,alum-7))))
   `(company-tooltip-selection ((,class (:foreground ,alum-1 :inverse-video t))))  
   ...
   `(company-tooltip-annotation ((,class (:inherit company-tooltip :foreground ,"#55aa55"))))
   `(company-tooltip-annotation-selection ((,class (:inherit company-tooltip-selection :foreground ,"#55aa55"))))
   `(company-scrollbar-bg ((,class (:inherit 'company-tooltip :background ,alum-7)))) 
   `(company-scrollbar-fg ((,class (:background ,alum-1))))
   `(company-tooltip-search ((,class (:inherit company-tooltip :foreground ,alum-7))))  
   `(company-preview ((,class (:foreground ,alum-1 :background ,alum-7)))) 
   ...
   ;; Org
   ;; `(org-agenda-date ((,class (:background ,alum-6 :foreground ,plum-1 :weight bold :height 1.4 :underline ,plum-3))))
   ;; `(org-agenda-date-today ((,class (:background ,alum-6 :foreground ,butter-1 :weight bold :height 1.5 :underline ,butter-2))))
   ;; `(org-super-agenda-header ((,class (:background ,alum-6 :foreground ,orange-3 :weight bold :height 1.2))))
   ;; `(org-tag ((,class (:background ,alum-6 :foreground ,plum-1 :weight bold :height 1.0 :underline ,plum-3))))
   ;; `(org-todo ((,class (:background ,alum-1 :foreground ,cham-3 :weight bold :height 1.0))))
   ;; `(org-scheduled-previously ((,class (:foreground ,red-1 :weight bold :height 1.0))))
   ;; `(org-scheduled-today ((,class (:foreground ,orange-1 :weight bold :height 1.0))))
   ...
   ;; `(minibuffer-prompt ((,class (:foreground ,butter-1 :height 1.0))))
   ...
   ;; Realgud
   `(realgud-overlay-arrow1  ((,class (:foreground "#55aa55"))))
